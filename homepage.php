...
<a href="logout.php" target="_blank" class="button first"><button>Logout</button><span></span></a>



<a href="index.php" target="_blank" class="button third"><button>Login</button><span></span></a>
